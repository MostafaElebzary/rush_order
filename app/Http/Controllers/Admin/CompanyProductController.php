...
class CompanyProductController extends Controller
{
    ...
    public function datatable(Request $request, $company_id)
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('actions', function ($row) {
                $actions = ' <a href="' . url("admin/edit-company_product/" . $row->id) . '" class="btn btn-icon btn-light-info"><i class="bi bi-pencil-fill"></i> </a>';
                return $actions;
    ...
    public function button($id)
    {
        ...
        return view('admin/company/product/button', $query);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.company.product.edit', $query);
    }
