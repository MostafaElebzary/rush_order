...
class CompanyCategoryController extends Controller
{
    ...
    public function datatable(Request $request, $company_id)
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('actions', function ($row) {
                $actions = ' <a href="' . url("admin/edit-company_category/" . $row->id) . '" class="btn btn-icon btn-light-info"><i class="bi bi-pencil-fill"></i> </a>';
                return $actions;
    ...
    public function button($id)
    {
        ...
        return view('admin/company/category/button', $query);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.company.category.edit', $query);
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect(url('admin/edit-company/' . $data->company_id))->with('message', 'تم التعديل بنجاح')->with('status', 'success');
    }
