...
@section('breadcrumb')
    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">موظفين الشركة</h1>
@endsection
                    ...
                    <div class="card-body py-4">
                        ...
                        <table class="table align-middle table-row-dashed fs-4 gy-5" id="data_table">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">الفرع(ان وجد)</th>
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#data_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('client.client.datatable.data') }}',
                    data: {}
                },
                columns: [
            ...
            $.ajax({
                url: "{{ URL::to('client/add-client-button')}}",
