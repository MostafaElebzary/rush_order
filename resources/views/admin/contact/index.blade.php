...
@section('breadcrumb')
    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">الشكاوى والاقتراحات </h1>
@endsection
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#data_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('contact.datatable.data') }}',
                    data: {}
                },
                columns: [
                    ...
                    {data: 'msg', name: 'msg', "searchable": true, "orderable": true},
            ...
            $.ajax({
                url: "{{ URL::to('admin/add-contact-button')}}",
