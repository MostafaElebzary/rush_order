                ...
                <div class="card-body py-4">
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="data_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">العنوان EN</th>
...
<script type="text/javascript">
    $(function () {
        var table = $('#data_table').DataTable({
            ...
            ajax: {
                url: '{{ route('pages.datatable.data') }}',
                data: {
            ...
            columns: [
                ...
                {data: 'name_en', name: 'phone', "searchable": true, "orderable": true},
                {data: 'created_at', name: 'is_active', "searchable": true, "orderable": true},
                {data: 'actions', name: 'actions', "searchable": false, "orderable": false},
            ]
        });
        $.ajax({
            url: "{{ URL::to('admin/add-page-button')}}",
