                    ...
                    <div class="card-body py-4">
                        ...
                        <table class="table align-middle table-row-dashed fs-4 gy-5" id="data_table">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">الملف(ان وجد )</th>
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                    <!--begin::Form-->
                                    <form id="" class="form" method="post" action="{{url('admin/store-settings')}}"
                                        ...
                                        <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="text" name="key"
                                                       ...
                                                       placeholder="الاسم" value="{{old('key')}}" required/>
                                                <!--end::Input-->
                                            </div>
                                            <div class="fv-row mb-7">
                                                <!--begin::Label-->
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#data_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('settings.datatable.data') }}',
                    data: {}
                },
                columns: [
            ...
            $.ajax({
                url: "{{ URL::to('admin/add-settings-button')}}",
