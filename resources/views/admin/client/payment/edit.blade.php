...
@section('breadcrumb')
    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0"> مدفوعات العميل  </h1>
@endsection
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <!--begin::Form-->
                <form id="kt_account_profile_details_form" action="{{url('admin/update-client-payment')}}" class="form"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <input type="date" name="date"
                                                           ...
                                                           placeholder="التاريخ" value="{{\Carbon\Carbon::parse($data->date)->format("Y-m-d")}}" required/>
                                                    <input type="hidden" name="id" value="{{$data->id}}">
