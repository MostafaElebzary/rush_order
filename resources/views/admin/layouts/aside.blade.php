    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{url('admin/slider')}}">
                        ...
                        <span class="menu-title">العروض والاعلانات</span>
                    </a>
                </div>
            </div>
            ...
            <div
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{url('admin/user')}}">
                        ...
                        <span class="menu-title">سجلات العملاء</span>
                    </a>
                </div>
            </div>
            <div
            ...
            <div
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{url('admin/contact')}}">
                        ...
                        <span class="menu-title">الشكاوى والملاحظات</span>
                    </a>
                </div>
            </div>
            <div
            ...
            <div
                ...
                id="#kt_aside_menu" data-kt-menu="true">
                <div class="menu-item">
                    <a class="menu-link" href="{{url('admin/reports/companies')}}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-muted svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none">
                        ...
                        <span class="menu-title">تقرير المنشآت</span>
                    </a>
                </div>
            </div>
            <div
                ...
                id="#kt_aside_menu" data-kt-menu="true">
                <div class="menu-item">
                    <a class="menu-link" href="{{url('admin/reports/users')}}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-muted svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none">
            ...
            <div
                ...
                id="#kt_aside_menu" data-kt-menu="true">
                <div class="menu-item">
                    <a class="menu-link" href="{{url('admin/notification-setting')}}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-muted svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none">
                        ...
                        <span class="menu-title">اعدادات الاشعارات </span>
                    </a>
                </div>
            </div>
