                ...
                <form id="kt_account_profile_details_form" action="{{url('admin/update-slider')}}" class="form"
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" name="title_ar" class="form-control mb-2"
                                                       placeholder="ادخل عنوان " value="{{$data->title}}"/>
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" name="title_en" class="form-control mb-2"
                                                       placeholder="ادخل عنوان " value="{{$data->title_en}}"/>
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                        <input type="text" name="sort" class="form-control mb-2"
                                                               placeholder="الترتيب" value="{{$data->sort}}"/>
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Input group-->
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{url('admin/slider')}}" id="kt_ecommerce_add_product_cancel"
