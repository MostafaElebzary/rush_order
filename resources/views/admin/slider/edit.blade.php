    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
                ...
                <!--begin::Content-->
                            ...
                            <!--begin::Form-->
                            <form id="kt_account_profile_details_form" action="{{url('admin/update-slider')}}" class="form"
                                                ...
                                                <div class="card card-flush py-4">
                                                    ...
                                                    <div class="card-body pt-0">
                                                        ...
                                                        <div class="mb-10 fv-row">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input type="text" name="title_ar" class="form-control mb-2" placeholder="ادخل عنوان " value="{{$data->title}}" />
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Input group-->
                                                        <!--begin::Input group-->
                                                        <div>
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Editor-->
                                                            <textarea name="content_ar" id="kt_docs_tinymce_basic">
                                                                {{$data->content}}
                                                            </textarea>
                                                            <!--end::Editor-->
                                                        </div>
                                                ...
                                                <div class="card card-flush py-4">
                                                    ...
                                                    <div class="card-body pt-0">
                                                        ...
                                                        <div class="mb-10 fv-row">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input type="text" name="title_en" class="form-control mb-2" placeholder="ادخل عنوان " value="{{$data->title_en}}" />
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Input group-->
                                                        <!--begin::Input group-->
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="sort" class="form-control mb-2" placeholder="الترتيب" value="{{$data->sort}}" />
                                                                    <!--end::Input-->
                                                                </div>
                                                                <!--end::Input group-->
