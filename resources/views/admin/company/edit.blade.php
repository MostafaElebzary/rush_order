                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0 row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <input type="file" name="commercial_file"
                                                           ...
                                                           />
                                                    <a class="btn btn-light-info" target="_blank" href="{{$data->commerical_file}}"><i class="bi  bi-file-arrow-down"></i></a>
                                                    <!--end::Input-->
                                                </div>
                                                <div class="fv-row mb-7">
                                                    <!--begin::Label-->
                                                ...
                                                <div class="fv-row mb-7">
                                                    <div
                                                        ...
                                                        <input
                                                            ...
                                                            value="1" id="flexSwitchDefault" @if($data->is_active == 1) checked @endif/>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="fv-row mb-7">
                                                    <!--begin::Label-->
                                                    <label class="col-lg-4 col-form-label fw-bold fs-6"> شعار الشركة</label>
                                                    <!--end::Label-->
                                                    <!--begin::Col-->
                                                    <div class="col-lg-8">
                                                        <!--begin::Image input-->
...
@section('js')
    ...
    {{--                        ],--}}
    {{--                        ajax: {--}}
    {{--                            url: '{{ route('company.debts.datatable.data',$data->id)}}',--}}
    {{--                            data: {}--}}
    {{--                        },--}}
    {{--                        columns: [--}}
    {{--                            {data: 'checkbox', name: 'checkbox', "searchable": false, "orderable": false},--}}
    ...
    {{--                    });--}}
    {{--                    $.ajax({--}}
    {{--                        url: "{{ URL::to('admin/add-company-debts-button/'.$data->id)}}",--}}
    {{--                        success: function (data) {--}}
